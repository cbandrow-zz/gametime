...
World.prototype.brickCheckCollision = function(left, right, up, down){
...
World.prototype.brickHitMid = function() {
    if(this.brickCheckCollision(1, 50, 1, 26)){
...
World.prototype.brickHitRight = function() {
  for (let i=0;i<this.brick.length;i++) {
    if (this.ball.x >= this.brick[i].x + 48
...
World.prototype.paddleBallCheck = function(left, right, up, down){
...
World.prototype.canCollideLeft = function() {
  if (this.paddleBallCheck(2, 15, 2, 10)){
    return true;
  }
}
World.prototype.canCollideMiddle = function() {
  if (this.paddleBallCheck(16, 59, 2, 10)){
    return true;
  }
}
